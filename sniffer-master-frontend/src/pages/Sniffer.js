				...
				<div className="head-title">
					...
					<a href="#" className="btn-download">
						...
						<CSVLink data={csvData} filename={'sniff-data.csv'} className="link">
							<span className="link-text">Descargar CSV </span>
					...
					<a href="#" className="btn-download">
						<i className='bx bxs-cloud-download'></i>
						<PDFDownloadLink document={<MyPDFDocument sniffData={csvData} />} fileName="sniff-data.pdf" className="link">
							<span className="link-text">Descargar PDF</span>
						</PDFDownloadLink>
					</a>
